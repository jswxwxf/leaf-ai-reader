/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1f4ed59da434f5a2a599d8cb8f91540b)
// Runtime types generated with workerd@1.20260410.1 2026-04-07 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		GEMINI_API_KEY_B: string;
		GEMINI_API_KEY_C: string;
		GEMINI_API_KEY_D: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "GEMINI_API_KEY" | "GEMINI_API_KEY_B" | "GEMINI_API_KEY_C" | "GEMINI_API_KEY_D">> {}
}
