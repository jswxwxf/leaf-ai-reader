  ...
  return (
    <footer className="h-20 bg-base-200 border-t border-base-300 px-4 flex flex-none items-center justify-center">
      <div className="flex items-center gap-4">
        <button className="btn btn-circle bg-primary/10 border-none hover:bg-primary/20" title="上一句">
        ...
        <button className="btn btn-circle bg-primary/10 border-none hover:bg-primary/20" title="下一句">
